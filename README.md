...
- **Approach**: ResNet-18 baseline + custom CNN with mixup augmentation and label smoothing
- **Result**: Test accuracy ~**[XX]%**, ROC-AUC ~**[XX]**
- 📁 [`task1_classification/`](task1_classification/)

### Task 2 — Lens Finding with Class Imbalance
- **Objective**: Binary detection of gravitational lenses in a heavily imbalanced dataset
- **Approach**: ResNet-18 with focal loss + oversampling; threshold tuning via ROC
- **Result**: AUROC ~**[XX]**, F1 ~**[XX]**
